...
const char* SetBoolStr[] = { // NOLINT(modernize-avoid-c-arrays)
    "AntiMoGlo",
    "AutoStart",
    "RedirectAll",
    "RedirectWhenHubFull",
...
const char* SetShortStr[] = { // NOLINT(modernize-avoid-c-arrays)
    "MaxUsers",
    "MinShareLimit",
    "MinShareUnits",
    "MaxShareLimit",
...
const char* SetTxtStr[] = { // NOLINT(modernize-avoid-c-arrays)
    "HubName",
    "AdminNick",
    "HubAddress",
    "TCPPorts",
