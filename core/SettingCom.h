...
const char* SetBoolCom[] = { // NOLINT(modernize-avoid-c-arrays)
...
const char* SetShortCom[] = { // NOLINT(modernize-avoid-c-arrays)
    ...
    "# Main chat deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 = "
    ...
    "# Same main chat deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 = "
    "permanently ban user\n",
    ...
    "# Same multiline main chat deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban "
    "user, 6 = permanently ban user\n",
    ...
    "# Private message deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 "
    "= permanently ban user\n",
    ...
    "# Same private message deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban "
    "user, 6 = permanently ban user\n",
    ...
    "# Same multiline private message action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban "
    "user, 6 = permanently ban user\n",
    "# Search deflood messages count. Must be higher than 0! Maximum 999\n",
    "# Search deflood time. Must be higher than 0! Maximum 999\n",
    "# Search deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 = "
    "permanently ban user\n",
    ...
    "# Same search deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 = "
    "permanently ban user\n",
    "# MyINFO deflood messages count. Must be higher than 0! Maximum 999\n",
    "# MyINFO deflood time. Must be higher than 0! Maximum 999\n",
    "# MyINFO deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 = "
    "permanently ban user\n",
    ...
    "# GetNickList deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 = "
    "permanently ban user\n",
    ...
    "# Secondary main chat deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban "
    "user, 6 = permanently ban user\n",
    ...
    "# Secondary private message deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary "
    "ban user, 6 = permanently ban user\n",
    ...
    "# Secondary search deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 "
    "= permanently ban user\n",
    ...
    "# Secondary MyINFO deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 "
    "= permanently ban user\n",
    ...
    "# ConnectToMe deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 = "
    "permanently ban user\n",
    ...
    "# Secondary ConnectToMe deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban "
    "user, 6 = permanently ban user\n",
    ...
    "# RevConnectToMe deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 = "
    "permanently ban user\n",
    ...
    "# Secondary RevConnectToMe deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban "
    "user, 6 = permanently ban user\n",
    ...
    "# SR deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 = permanently "
    "ban user\n",
    ...
    "# Secondary SR deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban user, 6 = "
    "permanently ban user\n",
    "# Maximal SR length. Must be higher than 0! Maximum 8192\n",
    "# Maximal received data deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = temporary ban "
    "user, 6 = permanently ban user\n",
    ...
    "# Secondary maximal received data deflood action. 0 = deflood disabled, 1 = ignore message, 2 = warn user, 3 = disconnect user, 4 = kick user, 5 = "
    "temporary ban user, 6 = permanently ban user\n",
...
const char* SetTxtCom[] = { // NOLINT(modernize-avoid-c-arrays)
