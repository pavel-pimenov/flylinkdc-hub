...
const bool SetBoolDef[] = { // NOLINT(modernize-avoid-c-arrays)
    true,               // ANTI_MOGLO
    false,              // AUTO_START
    false,              // REDIRECT_ALL
...
const int16_t SetShortDef[] = { // NOLINT(modernize-avoid-c-arrays)
    500,   // MAX_USERS
    0,     // MIN_SHARE_LIMIT
    0,     // MIN_SHARE_UNITS
    0,     // MAX_SHARE_LIMIT
...
#endif
    0, // std::to_underlying(SetShortIds::SETSHORT_MAX_USERS_PEAK)
};

const char* const SetTxtDef[] = { // NOLINT(modernize-avoid-c-arrays)
